...
Heurystyczne Prawo Zipf'a stonowi iż częstotliwość występowania danego słowa jest odwrotnie proporcjonalna do jego *rangi*

$$freq \sim \frac{1}{rank}$$  


$$tf(slowo, artykul) = \frac{n_{slowa \ w \ artykule}}{\sum n_{ liczby\ wystapien\ slow\ \ w \ artukule}} 
